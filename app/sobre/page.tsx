...
export default function SobrePage() {
  const team = [
    ...
    },
    {
      ...
      role: "Bióloga",
      description: "Bióloga e especialista em Licenciamento Ambiental com foco em gestão pública. Atua na implementação de serviços e supervisão de políticas públicas ambientais, assegurando que os projetos sejam sustententáveis e estejam em conformidade com a legislação vigente.",
      image: "/tamiris.jpg",
