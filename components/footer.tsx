        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="tel:+5514998851685" className="hover:text-accent transition-colors">
                  (14) 99885-1685
                </a>
              </div>
              <div className="flex items-center gap-2">
                <Mail className="w-4 h-4 flex-shrink-0" />
                <a href="mailto:ambientalcore@gmail.com" className="hover:text-accent transition-colors break-all">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2 text-sm">
              ...
              <Link href="/informacoes" className="hover:text-accent transition-colors">
                Informações
              </Link>
            </nav>
